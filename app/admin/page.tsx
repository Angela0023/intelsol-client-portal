...
export default function AdminPage() {
  ...
  const clients = [
    ...
    },
    {
      id: 'adsigner',
      name: 'AdSigner',
      industry: 'Email Signature Marketing Platform',
    ...
    },
    {
      id: 'plantryx',
      name: 'Plantryx',
      industry: 'Manufacturing SaaS / Supply Chain',
    ...
    },
    {
      id: 'mountaindrop',
      name: 'Mountaindrop',
      industry: 'Premium Supplements & Wellness',
    ...
    },
    {
      id: 'eblissai',
      name: 'eBlissAI',
      industry: 'AI-Native IT Operations Platform',
    ...
    },
    {
      id: 'zen2fit',
      name: 'Zen2Fit',
      industry: 'Corporate Wellness SaaS Platform',
    ...
    },
    {
      id: 'panorate',
      name: 'Panorate Media',
      industry: '3D Visualization for Industrial Manufacturers',
    ...
    },
    {
      id: 'mbedtronix',
      name: 'MBEDTRONIX',
      industry: 'Nearshore Embedded & Electronics Development',
      color: 'bg-indigo-100 text-indigo-600',
      borderColor: 'border-indigo-200',
      bgColor: 'bg-indigo-50',
    },
    ...
    },
    {
      id: 'stojkov',
      name: 'Stojkov',
      industry: 'Print & Packaging Manufacturing (Serbia)',
    ...
    },
    {
      id: 'bmevents',
      name: 'BM Events',
      industry: 'Event Promotions (Slovenia)',
      color: 'bg-sky-100 text-sky-600',
      borderColor: 'border-sky-200',
      bgColor: 'bg-sky-50',
    },
